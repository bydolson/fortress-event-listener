package fortress.eventlistener.configuration;
...
public class KafkaConfiguration {
    ...
    @Bean
    public ConsumerFactory<String, EventlistenerMessage> consumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventlistenerMessage> kafkaListenerContainerFactory() {
