...
import net.fortress.eventlistenerserver.integrationtest.utils.RestartingSpringRunner;
import org.junit.*;
...
public abstract class ServiceRestartRecoveryTests extends BaseKafkaIntegrationTest {
    ...
    protected void doBroadcastMissedBlocksOnStartupAfterFailureTest() throws Exception {
        ...
        //Ensure latest block has been updated in eventlistener
        waitForBroadcast();
        ...
        //Eventlistener will rebroadcast the last seen block after restart in case block
