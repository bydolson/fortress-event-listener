...
public class RabbitBroadcasterDBEventStoreIT extends BroadcasterSmokeTest {
    ...
    public void onContractEvent(EventlistenerMessage message) {
    ...
    public void onTransactionEvent(EventlistenerMessage message) {
        onTransactionMessageReceived((TransactionDetails) message.getDetails());
    }
    ...
    public void onBlockEvent(EventlistenerMessage message) {
