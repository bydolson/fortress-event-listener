...
import net.fortress.eventlistener.model.TransactionIdentifierType;
...
public class RegistrationIT extends BaseKafkaIntegrationTest {
    ...
    public void testRegisterEventFilterBroadcastsAddedMessage() throws InterruptedException {
        ...
        final EventlistenerMessage<ContractEventFilter> broadcastMessage = getBroadcastFilterEventMessages().get(0);
    ...
    public void testUnregisterEventFilterBroadcastsRemovedMessage() throws InterruptedException {
        ...
        final EventlistenerMessage<ContractEventFilter> broadcastMessage = getBroadcastFilterEventMessages().get(1);
    ...
    public void testRegisterTransactionMonitorBroadcastsAddedMessage() throws InterruptedException {
        ...
        final EventlistenerMessage<TransactionMonitoringSpec> broadcastMessage =
