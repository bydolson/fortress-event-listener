...
import net.fortress.eventlistener.endpoint.response.AddEventFilterResponse;
import net.fortress.eventlistener.endpoint.response.MonitorTransactionsResponse;
...
import net.fortress.eventlistenerserver.integrationtest.utils.SpringRestarter;
...
public class BaseIntegrationTest {
    ...
    protected void restartEventlistener(Runnable stoppedLogic) {
