...
package net.fortress.eventlistener.chain.service;
...
import net.fortress.eventlistener.constant.Constants;
...
import net.fortress.eventlistener.monitoring.MicrometerValueMonitor;
...
public class NodeHealthCheckServiceTest {
    ...
    private EventlistenerValueMonitor mockEventlistenerValueMonitor;
    ...
    public void init() throws Exception {
        ...
        mockEventlistenerValueMonitor = new MicrometerValueMonitor(new SimpleMeterRegistry());
