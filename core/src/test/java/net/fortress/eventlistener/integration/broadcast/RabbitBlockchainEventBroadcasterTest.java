...
import net.fortress.eventlistener.integration.broadcast.blockchain.RabbitBlockChainEventBroadcaster;
...
public class RabbitBlockchainEventBroadcasterTest {
    ...
    public void testBroadcastNewBlock() {
        ...
        final ArgumentCaptor<EventlistenerMessage> messageCaptor = ArgumentCaptor.forClass(EventlistenerMessage.class);
