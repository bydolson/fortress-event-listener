...
/**
 * A consumer for internal Eventlistener messages sent from a different instance.
 *
 * @author Craig Williams <craig.williams@fortress.net>
 */
public interface EventlistenerInternalEventConsumer {
    void onMessage(EventlistenerMessage<?> message);
}
