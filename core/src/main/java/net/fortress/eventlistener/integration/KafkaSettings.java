...
package net.fortress.eventlistener.integration;
 ...
 */
@Component("eventlistenerKafkaSettings")
...
public class KafkaSettings {
    ...
    @Value("${kafka.topic.eventlistenerEvents}")
    private String eventlistenerEventsTopic;
