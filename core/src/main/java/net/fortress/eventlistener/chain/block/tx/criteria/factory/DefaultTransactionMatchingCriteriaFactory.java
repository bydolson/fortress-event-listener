...
package net.fortress.eventlistener.chain.block.tx.criteria.factory;

import net.fortress.eventlistener.chain.block.tx.criteria.FromAddressMatchingCriteria;
import net.fortress.eventlistener.chain.block.tx.criteria.ToAddressMatchingCriteria;
import net.fortress.eventlistener.chain.block.tx.criteria.TransactionMatchingCriteria;
import net.fortress.eventlistener.chain.block.tx.criteria.TxHashMatchingCriteria;
