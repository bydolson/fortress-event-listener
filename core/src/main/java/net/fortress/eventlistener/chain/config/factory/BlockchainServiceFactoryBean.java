...
package net.fortress.eventlistener.chain.config.factory;

import lombok.Data;
import net.fortress.eventlistener.chain.service.BlockchainService;
import net.fortress.eventlistener.chain.service.block.EventBlockManagementService;
import net.fortress.eventlistener.chain.service.Web3jService;
