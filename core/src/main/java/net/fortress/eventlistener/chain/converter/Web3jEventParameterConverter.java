...
package net.fortress.eventlistener.chain.converter;

import net.fortress.eventlistener.dto.event.parameter.ArrayParameter;
import net.fortress.eventlistener.dto.event.parameter.EventParameter;
import net.fortress.eventlistener.dto.event.parameter.NumberParameter;
import net.fortress.eventlistener.dto.event.parameter.StringParameter;
import net.fortress.eventlistener.settings.EventlistenerSettings;
...
/**
 * Converts Web3j Type objects into Eventlistener EventParameter objects.
 *
...
public class Web3jEventParameterConverter implements EventParameterConverter<Type> {
    ...
    public Web3jEventParameterConverter(EventlistenerSettings settings) {
