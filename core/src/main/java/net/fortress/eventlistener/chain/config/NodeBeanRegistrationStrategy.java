...
package net.fortress.eventlistener.chain.config;

import lombok.AllArgsConstructor;
import net.fortress.eventlistener.chain.config.factory.ContractEventDetailsFactoryFactoryBean;
import net.fortress.eventlistener.chain.service.container.NodeServices;
import net.fortress.eventlistener.chain.service.health.NodeHealthCheckService;
import net.fortress.eventlistener.chain.service.health.WebSocketHealthCheckService;
import net.fortress.eventlistener.chain.service.health.strategy.HttpReconnectionStrategy;
import net.fortress.eventlistener.chain.service.health.strategy.WebSocketResubscribeNodeFailureListener;
import net.fortress.eventlistener.chain.service.strategy.PollingBlockSubscriptionStrategy;
import net.fortress.eventlistener.chain.service.strategy.PubSubBlockSubscriptionStrategy;
...
public class NodeBeanRegistrationStrategy {
    ...
    private String registerBlockchainServiceBean(Node node, Web3j web3j, BeanDefinitionRegistry registry) {
        ...
        final BeanDefinitionBuilder builder = BeanDefinitionBuilder.genericBeanDefinition(
                net.fortress.eventlistener.chain.service.Web3jService.class);
    ...
    private String registerNodeHealthCheckBean(Node node,
        ...
        builder.addConstructorArgReference("eventlistenerValueMonitor");
    ...
    private String registerNodeFailureListener(Node node,
        ...
        if (isWebSocketUrl(node.getUrl())) {
            final EventlistenerWebSocketService webSocketService = (EventlistenerWebSocketService) web3jService;
    ...
    private Web3jService buildWeb3jService(Node node) {
        ...
        if (isWebSocketUrl(node.getUrl())) {
            ...
            WebSocketService wsService = new EventlistenerWebSocketService(client, false);
