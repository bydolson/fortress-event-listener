...
package net.fortress.eventlistener.chain;

import lombok.AllArgsConstructor;
import net.fortress.eventlistener.chain.config.TransactionFilterConfiguration;
import net.fortress.eventlistener.dto.event.filter.ContractEventFilter;
import net.fortress.eventlistener.factory.ContractEventFilterFactory;
...
import net.fortress.eventlistener.chain.config.EventFilterConfiguration;
 ...
 * Eventlistener database on startup, or are returned from ContractEventFilterFactory beans.
 *
