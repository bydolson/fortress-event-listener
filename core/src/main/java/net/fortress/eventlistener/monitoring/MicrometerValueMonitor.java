...
package net.fortress.eventlistener.monitoring;

import io.micrometer.core.instrument.MeterRegistry;
import io.micrometer.core.instrument.Tags;

public class MicrometerValueMonitor implements EventlistenerValueMonitor {

    private static final String NAME_FORMAT = "eventlistener.%s.%s";
