...
/**
 * A service for manageing contract event subscriptions within the Eventlistener instance.
 *
...
public interface SubscriptionService {
     ...
     * @param broadcast Specifies if the added filter event should be broadcast to other Eventlistener instances.
     ...
     *
     * Broadcasts the removed filter event to any other Eventlistener instances.
     *
     ...
     *
     * @param filterId The filter id of the event to remove.
     * @param broadcast Specifies if the removed filter event should be broadcast to other Eventlistener instances.
     */
