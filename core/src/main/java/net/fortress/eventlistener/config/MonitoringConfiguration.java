...
public class MonitoringConfiguration {
    ...
    public class PrometheusConfiguration {
        ...
        public MeterRegistryCustomizer<MeterRegistry> metricsCommonTags(Environment environment) {
            return registry -> registry.config().commonTags("application", "Eventlistener", "environment", getProfileName(environment));
        }

        @Bean
        @ConditionalOnProperty(name="management.endpoint.metrics.enabled", havingValue = "true")
        public EventlistenerValueMonitor eventlistenerValueMonitor(MeterRegistry meterRegistry) {
    ...
    public class DoNothingMonitoringConfiguration {
        ...
        @Bean
        public EventlistenerValueMonitor eventlistenerValueMonitor() {
            return new EventlistenerValueMonitor() {
