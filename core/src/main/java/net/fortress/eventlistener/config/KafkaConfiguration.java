 ...
 */
@Configuration("eventlistenerKafkaConfiguration")
@EnableKafka
...
public class KafkaConfiguration {
    ...
    @Bean
    public KafkaAdmin eventlistenerAdmin() {
    ...
    @Bean
    public ProducerFactory<String, EventlistenerMessage> eventlistenerProducerFactory() {
    ...
    @Bean
    public ConsumerFactory<String, EventlistenerMessage> eventlistenerConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, null, new JsonDeserializer<>(EventlistenerMessage.class));
    }
    ...
    @Bean
    public KafkaTemplate<String, EventlistenerMessage> eventlistenerKafkaTemplate() {
        return new KafkaTemplate<>(eventlistenerProducerFactory());
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventlistenerMessage> eventlistenerKafkaListenerContainerFactory() {

        ConcurrentKafkaListenerContainerFactory<String, EventlistenerMessage> factory
                = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(eventlistenerConsumerFactory());
    ...
    @Bean
    public NewTopic eventlistenerEventsTopic(KafkaSettings kafkaSettings) {
        return new NewTopic(kafkaSettings.getEventlistenerEventsTopic(),
                kafkaSettings.getPartitions(), kafkaSettings.getReplicationSets().shortValue());
    }
