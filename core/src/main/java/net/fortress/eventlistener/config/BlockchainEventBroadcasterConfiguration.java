...
import net.fortress.eventlistener.integration.PulsarSettings;
import net.fortress.eventlistener.integration.RabbitSettings;
import net.fortress.eventlistener.integration.broadcast.blockchain.*;
...
public class BlockchainEventBroadcasterConfiguration {
    ...
    public BlockchainEventBroadcaster kafkaBlockchainEventBroadcaster(KafkaTemplate<String, EventlistenerMessage> kafkaTemplate,
